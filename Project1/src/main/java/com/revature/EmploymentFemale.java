...
public class EmploymentFemale {

public static void main(String[] args) throws Exception{
		
		if (args.length != 2){
			System.err.println("Usage: EmploymentFemale <input dir> <output dir>");
			System.exit(-1);
		}
		...
		job.setJobName("Employment Females Worldwide");
		...
		//Mapper and Reducer
		job.setMapperClass(EmploymentFemaleMapper.class);
