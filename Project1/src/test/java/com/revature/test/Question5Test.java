...
public class Question5Test {
	...
	public void testMapReduce(){
		...
		mapReduceDriver.withOutput(new Text("(Qatar) Females with no schooling(population 25+)(2014): "), new Text("2.97577%"));
		mapReduceDriver.withOutput(new Text("(Qatar) Married women are required by law to obey their husbands(2015): "), new Text("YES"));
		mapReduceDriver.withOutput(new Text("(Qatar) Women who believe a husband is justified in beating his wife (any of five reasons)(2012): "), new Text("6.6%\n==========================================================="));
