...
public class USEducationTest {
	...
	public void testMapper() {
		...
		mapDriver.withOutput(new Text("Educational attainment, completed short-cycle tertiary, population 25+ years, female (%): "), new DoubleWritable(10.87225 - 10.77392));
		mapDriver.withOutput(new Text("Educational attainment, completed short-cycle tertiary, population 25+ years, female (%): "), new DoubleWritable(10.75894 - 10.87225));
	...
	public void testReducer() {
		...
		values.add(new DoubleWritable(10.87225 - 10.77392));
		values.add(new DoubleWritable(10.75894 - 10.87225));
		
		reduceDriver.withInput(new Text("Educational attainment, completed short-cycle tertiary, population 25+ years, female (%): "), values);
		
		reduceDriver.withOutput(new Text("Educational attainment, completed short-cycle tertiary, population 25+ years, female (%): "), new DoubleWritable(-0.007489999999999775));
	...
	public void testMapReduce() {
		...
		mapReduceDriver.withOutput(new Text("Educational attainment, completed short-cycle tertiary, population 25+ years, female (%): "), new DoubleWritable(-0.007489999999999775));
